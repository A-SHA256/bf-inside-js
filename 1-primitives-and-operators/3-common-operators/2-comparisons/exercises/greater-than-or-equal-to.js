...
const _1_actual = Number('1') >= 1;
console.assert(_1_actual === _1_expect, 'Test 1');

const _2_expect = true; // 1 >= 0
const _2_actual = Number(true) >= Number(null);
console.assert(_2_actual === _2_expect, 'Test 2');

const _3_expect = false; // __
const _3_actual = -1 >= Number(false);
console.assert(_3_actual === _3_expect, 'Test 3');

const _4_expect = true; // __
const _4_actual = '0.0' >= Number(false);
console.assert(_4_actual === _4_expect, 'Test 4');

const _5_expect = false; // __
const _5_actual = Number(false) >= Number(true);
console.assert(_5_actual === _5_expect, 'Test 5');

const _6_expect = true; // __
const _6_actual = Number('13') >= Number(true);
